...
update_and_configure_system(){ 
    ...
    apt_install_yes "pavucontrol sox apt-transport-https ca-certificates autoconf automake libtool libudev-dev pkg-config   build-essential python3-pip libpython3-dev python3-dev doxygen vim wget htop curl g++ libconfig++-dev libpng++-dev python3-dbg graphviz bison flex"
...
# clone and build UHD
apt_install_yes "libboost-all-dev libncurses5  libncurses5-dev python-numpy python-numpy-dbg python-numpy-doc python3-numpy dpdk dpdk-dev"
...
# clone and build GR
apt_install_yes "swig liblog4cpp5-dev libgmp-dev libgmp3-dev python3-pyqt5 python3-sphinx python3-yaml python3-zmq libzmq3-dev libzmq5 python3-click python3-click-plugins libsdl1.2-dev libqwt-qt5-dev libqwtplot3d-qt5-dev libgsl-dev qt5-default libqt5opengl5-dev"
...
clone_and_cd gr-osmosdr https://github.com/osmocom/gr-osmosdr.git
cmake_and_ldconfig
...
apt_install_yes "libqt5svg5-dev portaudio19-dev liborc-0.4-dev"
...
clone_and_cd gr-iio https://github.com/analogdevicesinc/gr-iio.git
cmake_and_ldconfig
